        ...
        <div className="bg-dark">
            <footer>
                <ul className="nav justify-content-center border-bottom p-1">
                    ...
                    <li className="nav-item"><Link className="nav-link px-2 text-white" to="#">Application</Link></li>
                    <li className="nav-item"><Link className="nav-link px-2 text-white" to="#">Exhibition</Link></li>
